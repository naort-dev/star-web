...
export const fanInnerLinks = [
  ...
  { linkName: 'Favorite stars', selectedName: 'favorites', tooltip: 'Save your favorites and make it easy when booking a personalized shout-out.', url: '/manage/favorites' },
  { linkName: 'Profile', selectedName: 'profile', url: '/manage/profile' },
  { linkName: 'Refer A Star', selectedName: 'referStar', tooltip: 'Do you know a star that would be great on Starsona?  Get them signed up  using your referral code and earn a 20% commission! Read the terms.', url: '/manage/refer-star' },
];
...
export const starInnerLinks = [
  ...
  { linkName: 'Referral Program', selectedName: 'referral', tooltip: 'Do you have contacts that would enjoy Starsona? Help them sign up using your referral code and earn 20% of our commission!', url: '/manage/referral' },
];
