...
import {
  pipeSeparator,
  getStarName,
} from '../../../../utils/dataToStringFormatter';
...
const DetailSection = props => {
  ...
  useEffect(() => {
    if (
      ...
      props.celebDetails.description !== '' &&
      descpContentRef.current.clientHeight <= descpWrappRef.current.clientHeight
    ) {
      toggleShowMore(true);
    } else {
            ...
            {props.celebDetails.rating !== '' && (
              <div className="rating-section">
                <span className="details-header">
                  Avg Rating: {props.celebDetails.rating}
                </span>
                <StarRating
                  readOnly
        ...
        <DetailStyled.ProfileVideoSection visible={props.showProfileVideo}>
          ...
          <DetailStyled.ProfileVideo>
            <VideoRender
              ...
              customText={
                <span>
                  Watch {getShortName()}’s <br /> Welcome Message
                </span>
              }
              noBorder={
                document.body.getBoundingClientRect().width < 832 ||
