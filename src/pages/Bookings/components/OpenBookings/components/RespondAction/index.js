...
const RespondAction = props => {
  ...
  const [stateObject, updatedStateHandler] = useState({
    showHideFlg: false,
    buttonLabel: props.videoSrc ? 'Continue' : 'Start Recording',
    error: false,
    isStop: false,
  ...
  return (
    <Container>
      <h4 className='heading'>Record a Birthday shoutout for Sarah from Lisa</h4>
        <Layout>
