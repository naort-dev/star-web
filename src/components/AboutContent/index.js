    ...
    <AboutContentDiv.ProfileMainContent>
      ...
      <AboutContentDiv.ProfileDetailsWrapper>
        <AboutContentDiv.ProfileDetails>
          ...
          The trio began 2013 by playing a few North American dates and recording its debut album in Cook’s basement studio. The Bones of What You Believe appeared in September of that year and soon earned widespread critical acclaim as well as a strong fan base thanks to the group’s touring through 2014. Chvrches began working on new material in January 2015 at their own Alucard Studios, taking inspiration from Quincy Jones’ lean yet massive-sounding production style. Their second album, Every Open Eye, appeared in September 2015. ~ Heather Phares
        </AboutContentDiv.ProfileDetails>
        <AboutContentDiv.VideoHeading>My videos support a charity</AboutContentDiv.VideoHeading>
        <AboutContentDiv.ProfileDetails>
        I am supporting the following charity with each of my bookings. Thank you for partnering with me and helping to bring an end to this.
        </AboutContentDiv.ProfileDetails>
