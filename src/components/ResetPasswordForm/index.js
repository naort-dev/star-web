...
export default class ResetPassword extends React.Component {
  ...
  checkPassword = () => {
    ...
    if (validator.isEmpty(this.state.newPassword.value)) {
      this.setState({ newPassword: { ...this.state.newPassword, message: 'Enter a  password' } });
      return false;
    }
    if (!pattern.test(this.state.newPassword.value)) {
      this.setState({ newPassword: { ...this.state.newPassword, message: 'Enter a valid password must contain atleast one symbol' } });
      return false;
    }
    this.setState({ newPassword: { ...this.state.newPassword, message: '', isValid: true } });
                ...
                <LoginContainer.WrapsInput>
                  <LoginContainer.PasswordWrapper>
                    <LoginContainer.Input
                      ...
                      onChange={(event) => this.saveFormEntries(event, "newPassword")}
                ...
                <LoginContainer.WrapsInput>
                  <LoginContainer.PasswordWrapper>
                    <LoginContainer.Input
                      ...
                      onChange={(event) => this.saveFormEntries(event, "retypePassword")}
