...
export default class SignUp extends React.Component {
            ...
            .then(response => {
              if (response.status === 200) {
                if (response.data.data && response.data.data.user) {
                  if (
                    response.data.data.user.role_details.role_name ===
                      "Celebrity" &&
    ...
    this.props
      ...
      .then(response => {
        if (response.status === 200) {
          if (response.data.data && response.data.data.user) {
            if (
              response.data.data.user.role_details.role_name === "Celebrity" &&
              response.data.data.user.role_details.is_complete === false
            ) {
              this.props.changeStep(this.props.currentStep + 1);
            } else {
  ...
  checkRequired = () => {
    if (validator.isEmpty(this.state.firstName.value)) {
      this.setState({
        firstName: { ...this.state.firstName, message: "Enter a Firstname" }
      });
      return false;
    }
    this.setState({
              ...
              <LoginContainer.InputContainer>
                    ...
                    <LoginContainer.WrapsInput>
                      <LoginContainer.PasswordWrapper>
                        <LoginContainer.Input
                          ...
                          onChange={event =>
                            this.saveFormEntries(event, "password")
                          }
                ...
                <LoginContainer.PrivacyContent>
                  ...
                  <LoginContainer.Anchor
                    ...
                    href="https://about.starsona.com/privacy-policy/"
                  >
                    {" "}
                  ...
                  <LoginContainer.Anchor
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://about.starsona.com/terms-service/"
                  >
