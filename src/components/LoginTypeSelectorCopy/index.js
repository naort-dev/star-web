...
export class LoginTypeSelector extends React.Component  {
  ...
  updateGroupClick = () => {
    const { enableGroupCount } = this.state;
    if (enableGroupCount < 5) {
      this.setState({ enableGroupCount: enableGroupCount + 1 });
    }
  }
      ...
      <TypeSelectorWrapper>
        <TypeSelectorWrapper.ComponentWrapper>
          <TypeSelectorWrapper.OptionWrapper>
            <TypeSelectorWrapper.HeaderText onClick={this.updateGroupClick}>
              Create your account
